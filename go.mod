...
require (
	...
	github.com/whosonfirst/go-reader-github v0.4.1
	github.com/whosonfirst/go-reader-http v0.2.2
	github.com/whosonfirst/go-whosonfirst-findingaid v0.0.2
	github.com/whosonfirst/go-whosonfirst-github v0.3.1
